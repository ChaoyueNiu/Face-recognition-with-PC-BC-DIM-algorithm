...
ORL face dataset is also available for download from: http://www.cl.cam.ac.uk/research/dtg/attarchive/facedatabase.html

This code is modified based on 3.3.1 program and 3.2.6 program, I mainly focus on modifying demo.m program to develop an automatic method by combining 3.3.1 with 3.2.6. if you want to change the size of the images, please open my_alignment_2points_demo.m to modify original dataset is in att_faces folder Running demo.m , it will generate images resized and aligned, which will be saved in root dictionary.
